...
var XHR_CHARGEMENT_PAGE = false;
	...
	function init_page(){
		...
		if(element("liste_audio")!=null&&element("liste_audio").firstChild!=null){
			...
			lancer_fichier_audio('zone_fichiers',element("liste_audio").firstChild.lastChild.value,true); //'https://soundcloud.com/th-o-radio-m/la-fauchere-et-terre-de-liens'
		}
	}
...
function lancer_fichier_audio(zone,url,ne_pas_lancer){
