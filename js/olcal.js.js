		...
		var div_mois = document.createElement("div");
			...
			for(var m=0;m<tab_mois.length;m++){
				...
				var div_un_mois = document.createElement("div");
					...
					ajoute_evenement(div_un_mois,'click','_calendrier_creer_mois("2015-'+mois_courant+'-01","'+input.id+'");');
...
function ouvre_mois(){
	...
	element("calendrier").lastChild.className = "div_les_mois ouvert";
}
function ferme_mois(){
	element("calendrier").lastChild.className = "div_les_mois";
}
