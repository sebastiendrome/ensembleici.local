...
AJHV;
			...
			if ($evt_date_debut)
			{
			  ...
			  else
			  {
				...
				if(strlen($evt_heure_debut)>0) {$sortieheure = " à ".substr($evt_heure_debut,0,-3);}
				if (strlen($evt_heure_fin)>0) {$sortieheure = " de ".substr($evt_heure_debut,0,-3)." à ".substr($evt_heure_fin,0,-3);}	
