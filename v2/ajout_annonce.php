<?php
	...
	// include header
	$titre_page = "Ajouter un annonce";
	$titre_page_bleu = " ";
	$meta_description = "Ajouter une annonce sur Ensemble ici : Tous acteurs de la vie locale";
        ...
        <div id="agendalocal" class="blocB">
			...
			<div>
				<form name="recherche_form" id="recherche_form" action="" method="post" class="formA" >
					...
					<p>Entrez le nom de votre annonce stages / atelier / cours, afin de savoir si elle est déjà présente dans notre base de données. 
Le résultat de recherche vous permettra de créer votre propre annonce ou de modifier une annonce déjà existante.</p><br/>
					...
					<br/><br/>
					<center>
						<button type="submit" class="boutonbleu ico-fleche" onClick="return auto_recherche(document.recherche_form.nom_rech.value, document.recherche_form.cp_rech.value, 'annonce')">Rechercher</button></center>
