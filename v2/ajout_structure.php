<?php
	...
	$_SESSION['no_structure']=0;

	// include header
	$titre_page = "Ajouter une structure";
	$titre_page_bleu = " ";
	$meta_description = "Ajouter une structure sur Ensemble ici : Tous acteurs de la vie locale";
        ...
        <div id="formstructure" class="blocB">
			...
			<div>		
				<form name="recherche_form" id="recherche_form" action="" method="post" class="formA">
					...
					<p class="enlight">Entrez le nom de votre structure, afin de savoir si elle est d&eacute;j&agrave; présente dans notre base de donn&eacute;es.<br/> 
					Le r&eacute;sultat de recherche vous permettra de cr&eacute;er votre propre fiche structure ou modifier votre fiche d&eacute;j&agrave; existante.</p><br/><br/>
					...
					<br/><br/>
					<center><button type="submit" class="boutonbleu ico-fleche" onClick="return auto_recherche(document.recherche_form.nom_rech.value, document.recherche_form.cp_rech.value, 'structure')">Rechercher</button></center>
