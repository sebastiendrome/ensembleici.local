<?php
/*****************************************************
Gestion des tags associés à un élement
******************************************************/
...
<?php
	...
	$id_elt = intval($_SESSION['id_elt_passer']);
	// unset($_SESSION['id_elt_passer']);
...
<fieldset>
	...
	<input type="hidden" value="<?php echo $id_elt ?>" name="id_elt">
