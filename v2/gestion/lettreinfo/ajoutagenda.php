						...
						for(i=0;i<les_lignes.length;i++){
							var div_ligne = document.createElement("div");
								...
								if(les_lignes[i][2]){
									...
									div_ligne.style.backgroundColor = "#FEF2F2";
									div_ligne.setAttribute("onmouseover","this.style.backgroundColor='#FEE1E1'");
									div_ligne.setAttribute("onmouseout","this.style.backgroundColor='#FEF2F2'");
								}
