...
?>
    ...
    <h3>Ajouter un &eacutev&eacute;nement</h3>
...
<fieldset>
<label class="labellarge" for="input">Nom ou num&eacute;ro de l'&eacutev&eacute;nement</label>&nbsp;:&nbsp;<input class="input" id="input" name="input" type="text" size="35" onkeyup="recherche(this)" />
