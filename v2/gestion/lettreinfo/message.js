...
var angle_image = "angle2.png";
var bord_image = "bord2.png";
var fond_image = "fond2.png";
var position_script_dossier_images = "message/";

var largeur_defaut = 100; //en pixels
...
function creer_message(txt_html,id,parent,pos_x,pos_y,hauteur,largeur,overflow,align,boutons){
	...
	if(boutons!=false){
		div_message.style.top = div_message.offsetTop - 15 + "px";
		div_message.style.height = div_message.offsetHeight + 30 + "px";
