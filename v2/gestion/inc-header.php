...
<head>
  ...
  <script type="text/javascript" src="<?php echo $root_site; ?>js/admin_commun.js"></script>
...
<span id='base_url' style='display: none'><?= $root_site_prod ?></span>
<div id="ad-marge">
<div id="ad">
	<div id="ad-header">
