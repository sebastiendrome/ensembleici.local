...
// inisialitation du control de copie
$fairecopie = "";
...
<form id="adform1" action="domodifajout.php" method="post" class="formA" enctype="multipart/form-data">
  <div class="actions">
	...
	<input type="hidden"  name="faire_copie" id="faire_copie"  value="0">
	<script language="JavaScript">
		function set(nom_element){
			document.getElementById(nom_element).value="1";
		}
	</script> 
	<button type="submit" class="boutonbleu ico-ajout" onClick="set('faire_copie')">Créer une copie</button>
	<?php if ($lien_voir) { ?>
