...
function jsAfficherFormulaire_reponse(no_sujet, nom_ville, action, id_bouton, id_div_commentaires, no_message, no_utilisateur, titre_message){
	...
	if (bouton.value == "Répondre"){
		...
		var formulaire = "<form method=POST action=\""+action+"?envoi=ok&messagemessage="+no_message+"&reponse=ok\" onSubmit=\"return jsVerifCommentaire('"+no_message+"')\">";	
			...
			//formulaire += "<input type=\"hidden\" name=\"adresse_url\" id=\"adresse_url\" value=\""+action+"/citoyen."+nom_ville+"."+no_sujet+".html\"/>"; 
...
function jsAfficherFormulaire_modifs(id_ville, nom_ville, action, id_bouton, id_div, no_message, pseudo, descript, titre_message){
	...
	if (bouton.value == "Modifier"){
		...
		var formulaire = "<form method=POST action=\""+action+"?id_ville="+id_ville+"&nom_ville="+nom_ville+"&modif=ok&nomodif="+no_message+"\" onSubmit=\"return jsVerifModif('"+no_message+"')\" >";		
			...
			formulaire += "<input name=\"no_sujet\" type=\"hidden\" id=\"no_sujet\"  value=\""+id_ville+"\"/>";
			//formulaire += "<input type=\"hidden\" name=\"adresse_url\" id=\"adresse_url\" value=\""+action+"/citoyen."+nom_ville+"."+id_ville+".html\"/>"; 
...
function jsAfficherFormulaire_modifsPrincipal(id_ville, nom_ville, action, id_bouton, id_div, no_message, pseudo, descript, titre_message){
