...
<html>
    <head>
        ...
        <title>Ensemble ici | test sc</title>
        <style type="text/css">
                                ...
                                <td valign="top" class="preheaderContent" height="122" style='margin:0;padding:0;'>
                                    <table width="650" height="122" border="0" cellpadding="0" cellspacing="0">
                                        <tr><td colspan="4" rowspan="4" style='text-align:center;'>
                                            <span style='font-size:11px;color:rgb(194, 186, 178)'><a href="http://www.ensembleici.fr/02_medias/10_lettreinfo/2016_10_08_1/index.php?v=<?php echo $_GET['v']; ?>">Si ce message ne s'affiche pas correctement, visualisez la version en ligne.</a></span><br/>
...
<table style="width:100%;background-color:white; margin-left: 0px;" border="0" cellpadding="0" cellspacing="0">
    <tr>
        <td>
            ...
            <tr><td colspan="3" style="height:40px;background-color:#F0EDEA;border-bottom:2px solid #E3D6C7;border-top:2px solid #E3D6C7;font-weight:bold;color:#445158;padding-left:20px;padding-top:3px;font-size:17px;text-transform:uppercase;">Val d'Eygues</td></tr><tr><td width='33%' style='width:33%;vertical-align:top;padding:10px;border-bottom:1px solid #E3D6C7;border-right:1px solid #E3D6C7;'><a href="http://www.ensembleici.fr/evenement.nyons.yoga-detente-bien-etre.9568.536.html" style="text-decoration:none;" target="_blank"><div style='width:196px;height:120px;overflow:hidden;vertical-align:middle;'>                        <img src="http://www.ensembleici.fr/02_medias/05_evenement/1472559203_.jpg" style="width:159px;height:196px;margin:-38px auto 0 18px;" />
                    </div><br/>
                    <span style="font-size:16px;font-weight:bold;color:#E75B54;">YOGA, DETENTE, BIEN-ETRE</span>
                    <br/><span style="color:#445158;">Cours , NYONS</span><br/>
                    <strong style="color:black;font-weight:bold;font-size:11px;">du lundi 12 septembre 2016 au vendredi 29 juin 2018</strong>
                    </a></td>
...
<table style="width:100%;background-color:white;" border="0" cellpadding="0" cellspacing="0">
    ...
    <tr>
        <td>
            <table style="width:100%;" border="0" cellpadding="0" cellspacing="0">
            <tr style='border:none;height:40px;border-bottom:1px solid #F0EDEA;border-top:1px solid #F0EDEA;'><td style='width:30px;'></td><td><a href='http://www.ensembleici.fr/petiteannonce.nyons.entretiens-individuels.9568.1444728341.html' style='text-decoration:none;' target='_blank'>                <span style="color:#b9ba35;font-size:16px;font-weight:bold;">Entretiens individuels</span>
                <span>&nbsp;&nbsp;&nbsp;<img src='http://www.ensembleici.fr/img/monetaire.png' width='17px' height='17px' style='width:17px;height:17px;' title='Annonce monétaire' /></span>
                    ...
                    <td style="color:#445158;text-align:center;">
                            <a href='http://www.ensembleici.fr/petiteannonce.nyons.entretiens-individuels.9568.1444728341.html' style='text-decoration:none;' target='_blank'>                            <span style="font-weight:bold;">NYONS</span><br/>
                    </a></td>
