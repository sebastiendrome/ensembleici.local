...
<html>
    <head>
        ...
        <title>Ensemble ici | Ensemble Ici, tous acteurs de la vie locale !</title>
        <style type="text/css">
                                ...
                                <td valign="top" class="preheaderContent" height="122" style='margin:0;padding:0;'>
                                    <table width="650" height="122" border="0" cellpadding="0" cellspacing="0">
                                        <tr><td colspan="4" rowspan="4" style='text-align:center;'>
                                            <span style='font-size:11px;color:rgb(194, 186, 178)'><a href="http://www.ensembleici.fr/02_medias/10_lettreinfo/2016_09_21_1/index.php?v=<?php echo $_GET['v']; ?>">Si ce message ne s'affiche pas correctement, visualisez la version en ligne.</a></span><br/>
...
<table style="width:100%;background-color:white;" border="0" cellpadding="20" cellspacing="0">
    <tr>
        <td>
                                <p>Un dernier test pour la route. Pour Baronnies, sur les tests pr&eacute;c&eacute;dents, l'adresse de Patrick &eacute;crasait les votres ...</p>                <hr style='margin:10px 0;border:0;border-top:1px solid #E3D6C7;'/><p><div style="text-align: center; color: #2dabda;">Voici les infos de la semaine dont vous trouvez le d&eacute;tail sur le site Ensemble ici.<br /> Il vous est ais&eacute; d'en ajouter via les formulaires du site.<br /> Tous ensemble, solidaires, b&acirc;tissons cet outil de partage et d'info autog&eacute;r&eacute; pour mieux vivre sur notre territoire : &eacute;v&eacute;nements, activit&eacute;s, annonces, forums et articles!<br /> <br />
...
<div style='text-align:center;'>Si vous le souhaitez, vous pouvez consulter <a href='http://www.ensembleici.fr/02_medias/15_lettreinfo_pdf_annonces/annonces_l263_t1.pdf' target='_blank'>la liste complète des petites annonces au format PDF</a></div><br/>
<table style="width:100%;background-color:white;" border="0" cellpadding="0" cellspacing="0">
    ...
    <tr>
        <td>
            <table style="width:100%;" border="0" cellpadding="0" cellspacing="0">
            <tr style='border:none;height:40px;border-bottom:1px solid #F0EDEA;border-top:1px solid #F0EDEA;'><td style='width:30px;'></td><td><a href='http://www.ensembleici.fr/petiteannonce.nyons.reve-cherche-fourgon-.9568.1457614873.html' style='text-decoration:none;' target='_blank'>                <span style="color:#b9ba35;font-size:16px;font-weight:bold;">Rêve ! (cherche fourgon)</span>
                <span></span>
                    </a></td>
                    <td style="color:#445158;text-align:center;">
                            <a href='http://www.ensembleici.fr/petiteannonce.nyons.reve-cherche-fourgon-.9568.1457614873.html' style='text-decoration:none;' target='_blank'>                            <span style="font-weight:bold;">NYONS</span><br/>
                    </a></td>
                    <td style="width:30px;"></td>
                </tr>
                    <tr style='border:none;height:40px;border-bottom:1px solid #F0EDEA;border-top:1px solid #F0EDEA;'><td style='width:30px;'></td><td><a href='http://www.ensembleici.fr/petiteannonce.buis-les-baronnies.vends-sac-a-dos-millet-75-10.9424.1457614886.html' style='text-decoration:none;' target='_blank'>                <span style="color:#b9ba35;font-size:16px;font-weight:bold;">vends sac à dos millet 75+10</span>
                <span>&nbsp;&nbsp;&nbsp;<img src='http://www.ensembleici.fr/img/monetaire.png' width='17px' height='17px' style='width:17px;height:17px;' title='Annonce monétaire' /></span>
                    ...
                    <td style="color:#445158;text-align:center;">
                            <a href='http://www.ensembleici.fr/petiteannonce.buis-les-baronnies.vends-sac-a-dos-millet-75-10.9424.1457614886.html' style='text-decoration:none;' target='_blank'>                            <span style="font-weight:bold;">BUIS-LES-BARONNIES</span><br/>
                    </a></td>
                    <td style="width:30px;"></td>
                </tr>
                                <tr>
...
<table style="width:100%;background-color:white;" border="0" cellpadding="0" cellspacing="0">
    ...
    <tr>
        <td>
            <table style="width:100%;" border="0" cellpadding="0" cellspacing="0">
            <tr style='border:none;height:50px;border-bottom:1px solid #F0EDEA;border-top:1px solid #F0EDEA;'><td style='width:30px;'></td><td><a href='http://www.ensembleici.fr/structure.les-pilles.decor.9585.97.html' style='text-decoration:none;' target='_blank'>                <span style="color:#F6AE48;font-size:16px;font-weight:bold;">DECOR</span><br/>
                <span>DEveloppement des COmmunautés Rurales</span></a></td>
                <td style="color:#445158;text-align:center;">
                <a href='http://www.ensembleici.fr/structure.les-pilles.decor.9585.97.html' style='text-decoration:none;' target='_blank'>                        <strong style="font-weight:bold;">LES PILLES</strong><br/>
