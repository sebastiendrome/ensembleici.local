                                ...
                                <td valign="top" class="preheaderContent" height="122" style='margin:0;padding:0;'>
                                    <table width="650" height="122" border="0" cellpadding="0" cellspacing="0">
                                        <tr><td colspan="4" rowspan="4" style='text-align:center;'>
                                            <span style='font-size:11px;color:rgb(194, 186, 178)'><a href="http://www.ensembleici.fr/02_medias/10_lettreinfo/2016_09_19_1/index.php?v=<?php echo $_GET['v']; ?>">Si ce message ne s'affiche pas correctement, visualisez la version en ligne.</a></span><br/>
...
<table style="width:100%;background-color:white;" border="0" cellpadding="20" cellspacing="0">
    <tr>
        <td>
                                <p>Avec les pdf, sans les boutons envoyer &agrave; un ami et voir les march&eacute;s</p>                <hr style='margin:10px 0;border:0;border-top:1px solid #E3D6C7;'/><p><div style="text-align: center; color: #2dabda;">Voici les infos de la semaine dont vous trouvez le d&eacute;tail sur le site Ensemble ici.<br /> Il vous est ais&eacute; d'en ajouter via les formulaires du site.<br /> Tous ensemble, solidaires, b&acirc;tissons cet outil de partage et d'info autog&eacute;r&eacute; pour mieux vivre sur notre territoire : &eacute;v&eacute;nements, activit&eacute;s, annonces, forums et articles!<br /> <br />
...
<div style='text-align:center;'>Si vous le souhaitez, vous pouvez consulter <a href='http://www.ensembleici.fr/02_medias/14_lettreinfo_pdf_agenda/agenda_l260_t1.pdf' target='_blank'>l'agenda complet au format PDF </a></div><br/>
...
<div style='text-align:center;'>Si vous le souhaitez, vous pouvez consulter <a href='http://www.ensembleici.fr/02_medias/15_lettreinfo_pdf_annonces/annonces_l260_t1.pdf' target='_blank'>la liste complète des petites annonces au format PDF</a></div><br/>
