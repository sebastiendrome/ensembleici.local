...
$contenu .= '<div class="fiche">';
	...
	$contenu .= '<div style="clear:both;">';
		...
		//7. CONTACT EMAIL
		if(!empty($tab_item["no_contact"]))
			$contenu .= '<div class="ligne_info_fiche"><span class="span_courriel" onclick="fenetre_contact('.$tab_item["no_contact"].');">envoyer un courriel</span></div>';
		//7. PERSONNE CONTACT
