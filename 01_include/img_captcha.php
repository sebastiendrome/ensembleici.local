...
*/
$captchabgs = glob($root_serveur.'02_medias/02_captchabgs/*.png');
...
*/
$captchafonts = glob($root_serveur.'02_medias/03_fonts/*.otf');
...
*/
for ($i = 0; $i < 7; $i++) {
imagettftext($captchaimg, 36, $inclinaison[$i], (30*$i) +15, 50, $colors[array_rand($colors)], $captchafonts[array_rand($captchafonts)], $captcha[$i]);
}
