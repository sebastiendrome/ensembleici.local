...
$contenu .= '<div class="bloc" id="description">';
	$contenu .= '<div>';
		$contenu .= '<h1>'.(($PAGE=="evenement"||$PAGE=="structure"||$PAGE=="petite-annonce")?'Description':'Contenu').'</h1>';
                $contenu .= "<div style='color:#C00000'>Ne saisissez pas vos informations de contact dans la partie description ci-dessous car un formulaire vous permettra de le faire à l'étape 3</div>";
